...
{
    public partial class AdminPwChange : UIForm
    {
        public AdminPwChange()
        {
            InitializeComponent();
        }
        ...
        private void adminpdchange()
        {
            Dao dao = new Dao();
            string sql = String.Format("UPDATE Administrator SET LoginPW='{0}' WHERE Id='{1}'", CommonDefine.GetMD5Hash(UserPwNew.Text.Trim()),Data.AdID);
        ...
        private bool CheckInput()
        {
            ...
            Dao dao = new Dao();
            string sql = String.Format("SELECT * FROM Administrator WHERE Id='{0}' AND LoginPW='{1}'", Data.AdID, CommonDefine.GetMD5Hash(UserPwOld.Text.Trim()));
